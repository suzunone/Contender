 ...
 * @since      2020/03/28
 * @isdoc
 * @mixin \Contender\Elements\DummyMixin\DOMImplementation
 */
class Implementation
{
    /**
     ...
     * @return \Contender\Elements\DocumentType A new DOMDocumentType node with its ownerDocument set to &null;.
     * @since 5.0
     */
     ...
     * @param \Contender\Elements\DocumentType $doctype [optional] The type of document to create or &null;.
     * @return \Contender\Elements\Document A new DOMDocument object. If namespaceURI, qualifiedName, and doctype are null, the returned DOMDocument is empty with no document element
     * @since 5.0
     */
