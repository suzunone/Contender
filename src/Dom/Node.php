...
/**
 * Each element accessed from the {@link \Contender\Dom\Document}
 *
 *
 *
 * @category   Contender
...
class Node implements ElementInterface
{
    ...
    /**
     * Inserts a set of {@link \Contender\Dom\Node} or String in the children list of this ChildNode's parent, just after this ChildNode. Strings are inserted as equivalent Text nodes.
     *
     * @param \Contender\Dom\Node|string ...$elements
     * @return \Contender\Dom\Node|null
    ...
    /**
     * Inserts a set of {@link \Contender\Dom\Node}  or String in the children list of this ChildNode's parent, just before this ChildNode. Strings are inserted as equivalent Text nodes.
     *
     * @param \Contender\Dom\Node|string ...$elements
     * @return \Contender\Dom\Node|null
     * @see \Contender\Dom\Document::createElement()
